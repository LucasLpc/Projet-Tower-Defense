	...
	public void attaquer(Ennemi e) {
		if(this.env.getNbTours() % getCadence() == 0) {
			if(this.getEffet() == null) {
				TirSniper t = new TirSniper(this.getX(), this.getY(), this.env, this.degats, e, this.getEffet(), this);
				this.env.ajouterTir(t);
			}else if(this.getEffet() != null) {
				TirSniper t = new TirSniper(this.getX(), this.getY(), this.env, this.degats, e, this.getEffet().dupliquerEffet(), this);
				this.env.ajouterTir(t);
			}
		}
	}
